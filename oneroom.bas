...
191 PRINT"THE CB SWITCHED TO TRANSMIT. WHAT DO YOU WANT TO SAY? ":INPUTLINE I$

192 IF F%(14)=1 BT=BT+1:IFBT>=10P."SORRY BUDDY, BUT I CAN'T HEAR YOU ANYMORE. YOUR BATTERIES MUST BE LOW.":EX$(8)="THEY ARE DEAD.":F%(14)=0:G.48:EL.IF F%(14)=1P."I HEAR YOU OLD BUDDY, KEEP ON TALKING SO WE CAN FIND YOU.":BT=BT+1:G.48
...
269 REP.IF O<>37ORI$<>"OUTLET"U.1EL.PRINT"OK, CORD IS NOW PLUGGED INTO THEOUTLET.":EX$(O-6)="IT'S PLUGGED IN.":IF LEFT$(EX$(23),2)="CB" THEN F%(9)=1:EX$(23)="CB IS READY TO GO!":U.1:GOTO271:ELSE U.1:GOTO270
