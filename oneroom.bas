...
350 *|***** SAVE/LOAD ********
351 ONERROR ONERROROFF:CLOSE#0:V.7:P.'"ERROR. Couldn't save!":TIME=0:REP.U.TIME>300:GOTO37
...
357 ONERROR ONERROROFF:CLOSE#0:V.7:P.'"ERROR. Couldn't load!":TIME=0:REP.U.TIME>300:GOTO37
